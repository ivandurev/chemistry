var savedVars = ["money","reagents","equipped","zoom","xp","levelP","unlocked","tab","reaction","equipment[0].price","equipment[1].price","pages","fast"];
var lsl = undefined;
...
var reset = function()
{
	if(!confirm("Do you want to reset all your progress?")) return;
	localStorage.slot = undefined;
	if(tab != 0) changeTab(0);
	init();
	localStorage.slot = undefined;
	//console.log(localStorage.slot);
	//save();
}
...
var showSettings = function()
{
	...
	setTimeout(function(){updateSettings();$("#moreSettings").fadeIn("slow");},400);
}
